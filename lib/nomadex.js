  ...
  try {
    ...
    if (inputTokenType === 'ARC200' || outputTokenType === 'ARC200') {
      ...
      if (inputTokenType === 'ARC200' && Number(inputToken) !== 0) {
        ...
        const senderAddressBytes = algosdk.decodeAddress(sender).publicKey;
      ...
      if (outputTokenType === 'ARC200' && Number(outputToken) !== 0) {
        ...
        const factoryAppId = 411751;
        const factoryAddress = algosdk.getApplicationAddress(factoryAppId);
        const factoryAddressBytes = algosdk.decodeAddress(factoryAddress).publicKey;
