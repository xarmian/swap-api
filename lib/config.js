 ...
 * pool-ids.json exactly and captured a fully successful discovery. A partial
 * snapshot must never be replayed as if it were complete (CONVE-35) - if the
 * last run before a restart had failures, we deliberately re-discover
