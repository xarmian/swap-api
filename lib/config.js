...
import { discoverAllPools, getTokenMetadata } from './discovery.js';
...
async function initializeConfig() {
  ...
  discoveryPromise = (async () => {
    try {
      ...
      console.log(`[Config] Successfully loaded ${discovered.pools.length} pools and ${Object.keys(discovered.tokens).length} tokens`);
    } catch (error) {
