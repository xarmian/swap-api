...
async function findOptimalMultiHopRoute(routes, inputToken, outputToken, amount, slippage, address = '', maxCombinations = 100, poolInfoCache = createPoolInfoCache()) {
  ...
  // tie break and the shared mutable state (bestOutput, validRoutes,
  // poolIdsUsedAnywhere) behave exactly like the old sequential loop. Returns
  // true iff the candidate produced a successful quote.
