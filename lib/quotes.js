    ...
    for (const testCase of testCases) {
      if (testCase.p1Amount === 0n) {
        ...
        const quotes = await Promise.all([
          calculateQuoteForPool(poolCfg1, inputToken, outputToken, testCase.p1Amount.toString(), slippage, address, resolvedInfo1).catch(() => null),
          calculateQuoteForPool(poolCfg2, inputToken, outputToken, testCase.p2Amount.toString(), slippage, address, resolvedInfo2).catch(() => null)
        ]);
